...
void window_size_callback(GLFWwindow *window, int width, int height) {
    ...
    ResourcesManager::WINDOW_W = width;
    ResourcesManager::WINDOW_H = height;
}

int Events::initialize() {
    GLFWwindow *window = ResourcesManager::getWindow();
    _keys = new bool[1032];
...
void Events::toogleCursor() {
    ...
    //Event::setCursorMode(_cursor_locked ? GLFW_CURSOR_DISABLED : GLFW_CURSOR_NORMAL);
}
